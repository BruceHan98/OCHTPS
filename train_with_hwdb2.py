...
def eval(model, eval_dataset, criterion_kernel, criterion_char, epoch, is_save=True):
    eval_dataloader = DataLoader(dataset=eval_dataset, collate_fn=AlignCollate(), batch_size=2, shuffle=True, num_workers=0,
                                 pin_memory=False)
...
if __name__ == '__main__':
    ...
    for epoch in range(0, 50):
        ...
        eval(model, eval_data, criterion_kernel, criterion_char, epoch)
