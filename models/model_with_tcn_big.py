from models.det import PANNet
from models.rec import DenseNet_with_TCN_big
from models.connect_layer import Connect
import torch
...
class Model(nn.Module):
    ...
    def forward(self, img_tensors, gt_boxes=None, is_train=True):
        ...
        t1 = time.time()
        kernels, features = self.PAN_layer(img_tensors)
        # print(kernels.shape)
        t2 = time.time()
...
if __name__ == '__main__':
    ...
    for i in range(1):
        model(x, torch.tensor([[[[100, 100], [400, 100], [400, 80], [100, 80]]]]), True)
